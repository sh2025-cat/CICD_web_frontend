...
export const mockRepositories: Repository[] = [
    ...
    },
    {
        ...
        tag: 'v1.9.5 | b7e9f2a',
        commit_hash: 'b7e9f2a',
        commit_msg: 'API 응답 속도 최적화',
        deployed_at: '2025-11-20 11:11:11.000',
    },
];

export const mockVersions: Record<number, Version[]> = {
    1: [
        {
            commitSha: 'c9d8e7f',
...
export const mockDeploymentHistory: Record<number, DeploymentHistory[]> = {
    1: [
        {
            id: 'deploy-fe-001',
...
export function createNewDeployment(repoId: number, version: Version): string {
